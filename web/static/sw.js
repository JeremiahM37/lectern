...
const worker = self;
const CACHE = "lectern-react-4ff56d54b63d";
worker.addEventListener('install', event => event.waitUntil((async () => { await (await caches.open(CACHE)).addAll(["/","/icon.svg","/manifest.webmanifest","/fonts.css","/fonts/inter-latin.woff2","/fonts/inter-latin-ext.woff2","/react/assets/app-CH6T3xgd.css","/react/assets/app-H4Rl7xVb.js","/react/assets/terminal-BpODfoXp.js","/react/assets/terminal-CewVVPtL.css","/react/assets/viewport-D5nCZzjZ.js","/react/assets/viewport-DR5PCwew.css"]); await worker.skipWaiting(); })()));
