...
(() => {
  ...
  var worker = self;
  var CACHE = "lectern-react-90f58fc8555e";
  worker.addEventListener("install", (event) => event.waitUntil((async () => {
    await (await caches.open(CACHE)).addAll(["/","/icon.svg","/manifest.webmanifest","/fonts.css","/fonts/inter-latin.woff2","/fonts/inter-latin-ext.woff2","/react/assets/app-BByHA079.css","/react/assets/app-CYYG6gZy.js","/react/assets/terminal--ueVzdSu.js","/react/assets/terminal-CewVVPtL.css","/react/assets/viewport-DR5PCwew.css","/react/assets/viewport-HNwDtZFI.js"]);
