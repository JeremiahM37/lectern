...
const worker = self;
const CACHE = "lectern-react-9cad15a4738d";
worker.addEventListener('install', event => event.waitUntil((async () => { await (await caches.open(CACHE)).addAll(["/","/icon.svg","/manifest.webmanifest","/fonts.css","/fonts/inter-latin.woff2","/fonts/inter-latin-ext.woff2","/react/assets/app-C4xUwKS7.js","/react/assets/app-q_A318qT.css","/react/assets/terminal-BpODfoXp.js","/react/assets/terminal-CewVVPtL.css","/react/assets/viewport-D5nCZzjZ.js","/react/assets/viewport-DR5PCwew.css"]); await worker.skipWaiting(); })()));
