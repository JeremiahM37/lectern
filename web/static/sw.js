...
(() => {
  ...
  var worker = self;
  var CACHE = "lectern-react-d58dafbc1eb4";
  worker.addEventListener("install", (event) => event.waitUntil((async () => {
    await (await caches.open(CACHE)).addAll(["/","/icon.svg","/manifest.webmanifest","/fonts.css","/fonts/inter-latin.woff2","/fonts/inter-latin-ext.woff2","/react/assets/app-CwEtCP-3.js","/react/assets/app-CzRD_4NU.css","/react/assets/terminal-Banmt6Cj.js","/react/assets/terminal-BsW0wNtV.css","/react/assets/viewport-DR5PCwew.css","/react/assets/viewport-HNwDtZFI.js"]);
