...
const worker = self;
const CACHE = "lectern-react-71fa74caca66";
worker.addEventListener('install', event => event.waitUntil((async () => { await (await caches.open(CACHE)).addAll(["/","/icon.svg","/manifest.webmanifest","/fonts.css","/fonts/inter-latin.woff2","/fonts/inter-latin-ext.woff2","/react/assets/Review-CBLNiV_U.js","/react/assets/Review-DR5PCwew.css","/react/assets/app-DE9lOq5d.js","/react/assets/app-Daf1m0Nx.css","/react/assets/terminal-CfIRu0lm.js","/react/assets/terminal-D1lajMty.css"]); await worker.skipWaiting(); })()));
